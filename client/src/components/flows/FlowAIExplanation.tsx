...
interface FlowAIExplanationProps {
  explanation: AIExplanation | null;
  isLoading: boolean;
  onExplain: () => void;
}

export function FlowAIExplanation({
  explanation,
  isLoading,
  onExplain,
}: FlowAIExplanationProps) {
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              Get an AI-powered explanation of what this flow does
            </p>
          </div>
          <button
            onClick={onExplain}
